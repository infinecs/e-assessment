    ...
    <div class="col-span-12 xl:col-span-6">
        <div class="card dark:bg-zinc-800 dark:border-zinc-600">
            ...
            <div class="card-body border-b border-gray-100 dark:border-zinc-600 flex items-center justify-between">
                <h6 class="mb-1 text-gray-700 text-15 dark:text-gray-100">Assessment Questions</h6>
                    ...
                    <table class="w-full min-w-[1100px] text-xs text-center text-gray-500">
                        <thead
                            ...
                            <tr>
                                ...
                                <th class="px-6 py-3">Question Image</th>
                                <th class="px-6 py-3">Default Topic</th>
                        ...
                        <tbody>
                            @forelse($records as $row)
                                <tr class="bg-white border-b hover:bg-gray-50/50 dark:bg-zinc-700 dark:hover:bg-zinc-700/50 dark:border-zinc-600">
                                    ...
                                    <td class="px-6 py-4 text-left">{{ Str::limit($row->QuestionText, 50) }}</td>

                                    <!-- Show Question Image if exists -->
                                    <td class="px-6 py-4">
                                        @if($row->QuestionImage)
                                            <span class="text-blue-600 underline">{{ $row->QuestionImage }}</span>
                                        @else
                                            -
                                        @endif
                                    </td>
                                    ...
                                    <td class="px-6 py-4">{{ $row->DefaultTopic }}</td>
                            ...
                            @empty
                                <tr>
                                    <td colspan="7" class="px-6 py-4 text-center">No questions found</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
